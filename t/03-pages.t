...
subtest one => sub {
	...
	my $data = eval { Perl::Maven::Page->new( root => 't/files', file => $path )->read->data };
...
subtest abstract_not_ending => sub {
	...
	my $data_1 = eval { Perl::Maven::Page->new( root => 't/files', file => $path_1 )->read->data };
...
subtest one_with_config => sub {
	...
	my $data    = eval {
		Perl::Maven::Page->new( root => 't/files', file => $path )
